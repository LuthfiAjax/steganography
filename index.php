...
<body>
    <div class="container">
        ...
        <div id="my-tab-content" class="tab-content">
            <div class="tab-pane active" id="encode">
                <div>
                    ...
                    <p class="alert alert-info">
                        ...
                        Remember, the more text you want to hide, the larger the image has to be. In case you chose an
                        image that is too small to hold your message you will be informed.<br /><br />
                        Neither the image nor the message you hide will be at any moment transmitted over the web, all
            ...
            <div class="tab-pane" id="decode">
                <div>
                    <h2>Decode image</h2>
                    <p class="alert alert-info">
                        To decode a hidden message from an image, just choose an image and hit the
                        <strong>Decode</strong> button.<br /><br />
        ...
        <footer style="text-align: center; margin-top: 20px; margin-bottom: 10px;">
            &copy; <?= date("Y"); ?> by <a href="mailto:seajaxid@gmail.com">JaxID</a>
        </footer>
    </div>
